...
class WSClient:
    ...
    def is_connected(self) -> bool:
        ...
        return self.status == ConnectionStatus.CONNECTED and self.websocket is not None
    ...
    async def _schedule_reconnect(self):
        ...
        if self.reconnect_policy == ReconnectPolicy.ON_ERROR and self.status != ConnectionStatus.ERROR:
            return
