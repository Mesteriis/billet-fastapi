"""
TestAdvanced API tests for Advanced level.
...
from tests.factories.test_advanced_factories import TestAdvancedFactory
from apps.test_advanced.schemas.test_advanced_schemas import TestAdvancedStatus


class TestTestAdvancedAdvancedAPI:
    """Advanced test suite for TestAdvanced API endpoints."""

    @pytest.fixture
    async def sample_testadvanced(self, testadvanced_factory: TestAdvancedFactory):
        """Create a sample testadvanced for testing."""
        return await testadvanced_factory.create(
            name="Test Advanced TestAdvanced",
    ...
    async def test_create_testadvanced_advanced(self, api_client: AsyncClient):
        """Test creating testadvanced with advanced features."""
        create_data = {
            "name": "Advanced Test TestAdvanced",
        ...
        response = await api_client.post(
            api_client.url_for("create_testadvanced"),
            json=create_data
        )
    ...
    async def test_create_testadvanced_validation_error(self, api_client: AsyncClient):
    ...
    async def test_advanced_search_comprehensive(self, api_client: AsyncClient, testadvanced_factory: TestAdvancedFactory):
        """Test comprehensive advanced search functionality."""
        # Create test data with various attributes
        await testadvanced_factory.create_batch(
            5,
        ...
        response = await api_client.post(
            api_client.url_for("search_testadvanceds"),
            json=search_request
        )
    ...
    async def test_search_with_complex_filters(self, api_client: AsyncClient, testadvanced_factory: TestAdvancedFactory):
        """Test search with complex filtering combinations."""
        # Create diverse test data
        await testadvanced_factory.create(
    ...
    async def test_get_statistics(self, api_client: AsyncClient, testadvanced_factory: TestAdvancedFactory):
    ...
    async def test_list_with_advanced_filters(self, api_client: AsyncClient, testadvanced_factory: TestAdvancedFactory):
        ...
        response = await api_client.get(
            api_client.url_for("list_testadvanceds"),
            params={
                "page": 1,
                "size": 10,
                "status": "active",
    ...
    async def test_middleware_headers(self, api_client: AsyncClient, sample_testadvanced):
    ...
    async def test_performance_monitoring(self, api_client: AsyncClient, testadvanced_factory: TestAdvancedFactory):
    ...
    async def test_error_handling_with_context(self, api_client: AsyncClient):
        ...
        response = await api_client.get(
            api_client.url_for("get_testadvanced", testadvanced_id=99999)
        )
    ...
    async def test_tag_operations(self, api_client: AsyncClient, sample_testadvanced):
        """Test advanced tag operations."""
        testadvanced_id = sample_testadvanced.id
        
        # Test adding tags
        new_tags = ["urgent", "customer-request", "high-impact"]
        
        response = await api_client.patch(
            api_client.url_for("add_tags", testadvanced_id=testadvanced_id),
            json=new_tags
        )
    ...
    async def test_priority_update_validation(self, api_client: AsyncClient, sample_testadvanced):
        """Test priority update with business rule validation."""
        testadvanced_id = sample_testadvanced.id
        
        # Test valid priority update
        response = await api_client.patch(
            api_client.url_for("update_priority", testadvanced_id=testadvanced_id),
            json=9
        )
