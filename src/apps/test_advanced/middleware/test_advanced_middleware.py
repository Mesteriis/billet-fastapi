"""
TestAdvanced logging middleware for Advanced level.
...
logger = logging.getLogger("middleware.test_advanced")


class TestAdvancedLoggingMiddleware(BaseHTTPMiddleware):
    """
    Advanced logging middleware for TestAdvanced operations.
    ...
    Example:
        ...
        >>> from apps.test_advanced.middleware.logging_middleware import TestAdvancedLoggingMiddleware
        >>> 
        >>> app = FastAPI()
        >>> app.add_middleware(TestAdvancedLoggingMiddleware)
    """
