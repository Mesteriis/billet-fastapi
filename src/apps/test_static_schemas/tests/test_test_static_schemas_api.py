"""
TestStaticSchema API tests for Advanced level.
...
from tests.factories.test_static_schemas_factories import TestStaticSchemaFactory
from apps.test_static_schemas.schemas.test_static_schemas_schemas import TestStaticSchemaStatus


class TestTestStaticSchemaAdvancedAPI:
    """Advanced test suite for TestStaticSchema API endpoints."""

    @pytest.fixture
    async def sample_teststaticschema(self, teststaticschema_factory: TestStaticSchemaFactory):
        """Create a sample teststaticschema for testing."""
        return await teststaticschema_factory.create(
            name="Test Advanced TestStaticSchema",
    ...
    async def test_create_teststaticschema_advanced(self, api_client: AsyncClient):
        """Test creating teststaticschema with advanced features."""
        create_data = {
            "name": "Advanced Test TestStaticSchema",
        ...
        response = await api_client.post(
            api_client.url_for("create_teststaticschema"),
            json=create_data
        )
    ...
    async def test_create_teststaticschema_validation_error(self, api_client: AsyncClient):
    ...
    async def test_advanced_search_comprehensive(self, api_client: AsyncClient, teststaticschema_factory: TestStaticSchemaFactory):
        """Test comprehensive advanced search functionality."""
        # Create test data with various attributes
        await teststaticschema_factory.create_batch(
            5,
        ...
        response = await api_client.post(
            api_client.url_for("search_teststaticschemas"),
            json=search_request
        )
    ...
    async def test_search_with_complex_filters(self, api_client: AsyncClient, teststaticschema_factory: TestStaticSchemaFactory):
        """Test search with complex filtering combinations."""
        # Create diverse test data
        await teststaticschema_factory.create(
    ...
    async def test_get_statistics(self, api_client: AsyncClient, teststaticschema_factory: TestStaticSchemaFactory):
    ...
    async def test_list_with_advanced_filters(self, api_client: AsyncClient, teststaticschema_factory: TestStaticSchemaFactory):
        ...
        response = await api_client.get(
            api_client.url_for("list_teststaticschemas"),
            params={
                "page": 1,
                "size": 10,
                "status": "active",
    ...
    async def test_middleware_headers(self, api_client: AsyncClient, sample_teststaticschema):
    ...
    async def test_performance_monitoring(self, api_client: AsyncClient, teststaticschema_factory: TestStaticSchemaFactory):
    ...
    async def test_error_handling_with_context(self, api_client: AsyncClient):
        ...
        response = await api_client.get(
            api_client.url_for("get_teststaticschema", teststaticschema_id=99999)
        )
    ...
    async def test_tag_operations(self, api_client: AsyncClient, sample_teststaticschema):
        """Test advanced tag operations."""
        teststaticschema_id = sample_teststaticschema.id
        
        # Test adding tags
        new_tags = ["urgent", "customer-request", "high-impact"]
        
        response = await api_client.patch(
            api_client.url_for("add_tags", teststaticschema_id=teststaticschema_id),
            json=new_tags
        )
    ...
    async def test_priority_update_validation(self, api_client: AsyncClient, sample_teststaticschema):
        """Test priority update with business rule validation."""
        teststaticschema_id = sample_teststaticschema.id
        
        # Test valid priority update
        response = await api_client.patch(
            api_client.url_for("update_priority", teststaticschema_id=teststaticschema_id),
            json=9
        )
