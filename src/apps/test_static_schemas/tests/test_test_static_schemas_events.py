"""
Tests for TestStaticSchema event service.
...
from apps.test_static_schemas.services.test_static_schemas_event_service import (
    TestStaticSchemaEventService,
    DomainEvent,
    EventHandler
)
...
class TestEventService:
    """Test cases for TestStaticSchema event service."""

    @pytest.fixture
    def event_service(self):
        """Create event service instance."""
        return TestStaticSchemaEventService()
    ...
    def sample_event(self):
        ...
        return DomainEvent(
            ...
            event_type="teststaticschema_created",
            entity_id="1",
            entity_type="teststaticschema",
            payload={"name": "Test TestStaticSchema", "status": "active"},
    ...
    async def test_subscribe_handler(self, event_service):
        ...
        handler = EventHandler(
            ...
            event_types=["teststaticschema_created"],
            handler_func=test_handler
        )
        
        event_service.subscribe(handler)
        
        assert "teststaticschema_created" in event_service.handlers
        assert handler in event_service.handlers["teststaticschema_created"]
    ...
    async def test_event_stream_processing(self, event_service):
        ...
        event_service.subscribe(EventHandler(
            ...
            event_types=["teststaticschema_created", "teststaticschema_updated"],
        ...
        events = [
            DomainEvent(
                ...
                event_type="teststaticschema_created" if i % 2 == 0 else "teststaticschema_updated",
                entity_id=str(i),
                entity_type="teststaticschema",
    ...
    async def test_event_filtering(self, event_service):
        ...
        event_service.subscribe(EventHandler(
            ...
            event_types=["teststaticschema_updated"],
        ...
        events = [
            ...
            DomainEvent(
                event_id="updated-1",
                event_type="teststaticschema_updated",
                entity_id="1",
                entity_type="teststaticschema",
    ...
    async def test_event_statistics(self, event_service):
        ...
        with patch.object(event_service, 'get_statistics') as mock_stats:
            ...
            assert stats["events_by_type"]["teststaticschema_created"] == 5
