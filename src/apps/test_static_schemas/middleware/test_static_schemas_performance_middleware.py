"""
TestStaticSchema performance middleware for Enterprise level.
...
logger = logging.getLogger("performance.test_static_schemas")


class TestStaticSchemaPerformanceMiddleware(BaseHTTPMiddleware):
    """
