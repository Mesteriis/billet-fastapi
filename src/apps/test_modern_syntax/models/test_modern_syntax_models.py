"""
TestModernSyntax model definition for Enterprise level.
...
class TestModernSyntax(BaseModel):
    """
    TestModernSyntax model for test_modern_syntax application (Enterprise level).
    ...
    __tablename__ = "test_modern_syntax"
